...
from utils.config import AZURE_USER, AZURE_PASSWORD, AZURE_HOSTNAME, AZURE_PORT, AZURE_DATABASE
...
def get_ssl_cert():
    try:
        with open('encoded_cert.txt', 'r') as f:
        ...
        logger.error(f"Failed to create SSL certificate: {str(e)}")
        raise
