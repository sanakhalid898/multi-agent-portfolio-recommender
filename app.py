...
from agents.preference_parser import PreferenceParserAgent

def show_investment_assistant_page():
    ...
    st.markdown("""
    Welcome to your personal Investment Assistant! I'm here to help you with:
    ...
    if prompt := st.chat_input("Ask me anything about investing..."):
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                response = educator.provide_education(prompt)
...
if not st.session_state.authenticated:
    ...
    if st.query_params.get("endpoint", None) == "news":
        ...
        nav_items = ["Home", "Get Recommendations", "Trade", "Portfolio", "Investment Assistant", "Leaderboard"]
        ...
        if page == "Home":
            ...
            show_investment_assistant_page()
